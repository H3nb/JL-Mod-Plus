...
| Google support transitives used by the runtime graph: Guava/failureaccess/listenablefuture, Error Prone annotations, J2ObjC annotations and JSR-305 | Google / FindBugs projects | Apache-2.0 as published for these artifacts |
