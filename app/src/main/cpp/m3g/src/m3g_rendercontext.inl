...
{
    EGLSurface surf;
    EGLConfig config = m3gQueryEGLConfig(format, bufferBits, EGL_WINDOW_BIT, (M3GNativeBitmap)0);
                                          ...
                                          M3Gint width, M3Gint height)
{
    ...
    config = m3gQueryEGLConfig(format, bufferBits, EGL_PBUFFER_BIT, (M3GNativeBitmap)0);
    if (!config) {
        return NULL;
    }
