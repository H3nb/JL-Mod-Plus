...
The optional 44.1 kHz synthesis mode and removal of TinySoundFont are intentionally deferred until this 22.05 kHz core passes CI and real-game/audio corpus validation. That keeps sample-rate changes and synth-parity decisions separate from the engine/routing migration.
