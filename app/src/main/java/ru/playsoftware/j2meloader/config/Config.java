...
public class Config {
	...
	/** Versioned Memory Editor source/runtime binding metadata paired with the converted payload. */
	public static final String MIDLET_MEMORY_METADATA = "/memory-editor.meta";
