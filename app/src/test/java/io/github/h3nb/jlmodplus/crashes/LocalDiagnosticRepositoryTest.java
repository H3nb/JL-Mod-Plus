...
public class LocalDiagnosticRepositoryTest {
	...
	@Test
	public void topAppFrameRecognizesCanonicalMediaAndGraphicsFrames() {
		String stack = "java.lang.IllegalStateException: boom\n"
				+ "\tat io.github.h3nb.jlmodplus.mmapi.synth.tsf.LibTSF.start(LibTSF.java:67)\n"
				+ "\tat io.github.h3nb.jlmodplus.micro3d.Utils.glReadPixels(Utils.java:95)\n"
				+ "\tat io.github.h3nb.jlmodplus.config.ConfigActivity.onCreate(ConfigActivity.java:184)";

		assertEquals("io.github.h3nb.jlmodplus.mmapi.synth.tsf.LibTSF.start(LibTSF.java:67)",
				LocalDiagnosticRepository.topAppFrame(stack));
	}
}
